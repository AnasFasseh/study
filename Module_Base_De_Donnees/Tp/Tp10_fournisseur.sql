...
create user 'Morad'@'localhost' identified by '98763';
create user 'Amina'@'localhost' identified by '2345';
create user'Said'@'localhost' identified by '000';
#Q2
create user 'Karim'@'%' identified by 'DER344';
create user 'Ahmed'@'%' identified by 'OPU888';
create user 'Al'@'%' identified by 'a5438';
#preveliges Q3
grant all privileges on *.* to 'Said'@'localhost';
grant select,insert,update on biblio.* to 'Amina'@'localhost';
grant select on gestion_produits.* to 'Karim'@'%';
grant all privileges on *.* to 'Laila'@'localhost';
revoke delete on *.* from 'Laila'@'localhost';
grant select,insert,update,delete on dbemployee.emp to 'Morad'@'localhost';
grant select(matr,poste) on dbemployee.emp to 'Ahmed'@'%';
grant select,insert,update(prix) on gestion_produits.produits to 'Al'@'%';
#Q4
revoke delete on gestion_produits.* from 'Karim'@'%';
#Q5
revoke insert on biblio.* from 'Amina'@'%';
#Q6 impossible dans mySQL maintenent l3am jay incha2lah
revoke select(sal,poste) on dbemployee.emp from 'Laila'@'localhost';
#Q7
drop user 'Said'@'localhost';
...
delete from admine;
alter table admine
add droit varchar(20);
insert into admine values('admin','123','admin');
insert into admine values('user','000','user');
...
insert into Produits values ('P01', NULL, 'Marrakech', 120,'images/hucker')
, ('P02', 'Argane', 'Agadir', 200,'images/goku.jpg')
, ('P03', 'Argane', 'Ouarzazate', 400,'images/error.jpg')
, ('P04', 'Argane', 'Taroudant', 500,'images/coding.jpg')
,('P05', 'Olive', 'Marrakech', 250,'images/img3.jpg')
, ('P06', 'Dra3ia', 'Marrakech', 100,'images/thelast.jpg')
, ('P07', 'Dra3ia', 'Fes', 800,'')
